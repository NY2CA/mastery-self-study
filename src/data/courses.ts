...
export const COURSES: Course[] = [
  {
    ...
    modules: [
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        topics: [
          // ── Topic 0 · Foundations primer (ported from M101 Module 4) ─
          {
            id: 'submarket-t00-foundations-framework',
            title: 'The four-driver framework — your foundation for any market',
            summary:
              'Wages, jobs, households, supply. The four primary demand drivers that explain almost everything about multifamily rent growth in any U.S. metro, in any cycle. The literacy that sits underneath every operator-tier read in this module.',
            body:
              "Most submarket analysis jumps straight into the three operator-tier reads — population trajectory, employment diversity, and supply pipeline — that determine whether a *specific* deal in a *specific* submarket pencils. Before any of that, every operator-credible market read sits on top of a more foundational framework: **the four primary demand drivers** that explain almost everything about multifamily rent growth in any U.S. metro, in any cycle.\n\nThese are the operator's universal starting point. Understanding them is what separates reading the market report from *reading the market*. Master these four and the operator-tier topics that follow in this module become legible as refinements — not standalone questions.\n\n**The four primary drivers:**\n\n- **Wages.** Median household wages in the metro and submarket. Tells you the ceiling on what tenants can pay. Working-renter households typically pay 25-35% of gross income on rent. Wage growth above national average for multiple consecutive years is the strongest single signal that rent has room to grow. Pull from BLS QCEW (`bls.gov/cew`) and Census ACS.\n\n- **Jobs.** Total non-farm employment plus the *composition* of jobs being added. Total job count is necessary but not sufficient — the wage tier of jobs added determines which class of multifamily tightens. 18,000 logistics warehouse jobs is a different rent story than 18,000 tech HQ jobs. Pull from BLS LAUS and CES.\n\n- **Households.** Net new households formed — through migration, population growth, and formation rate. Population growth without household formation does not produce rent demand. The driver is households, not bodies. Pull from Census ACS plus state demographer offices.\n\n- **Supply.** Units under construction and in the 24-month pipeline. The only driver an operator can directly see — every construction site is visible from the road, every permit is public record. Supply is the variable that turns a great demand story into a mediocre rent-growth story (when too much lands at once). Pull from municipal permit offices plus free deliveries trackers (Apartment List, CBRE Quarterly, Yardi Matrix).\n\n**Signal thresholds (orientation, not absolutes):**\n\n- **Green** market — wage growth > +1.5% real vs. national; job growth > +1.5% annual with diversified composition; household formation > +1.0% annual; 24-month supply pipeline < 2% of stock.\n- **Yellow** market — any single driver in the +0.5 to +1.5% (or 2 to 4% supply) band.\n- **Red** market — any driver below 0%, or supply > 4% of stock.\n\n**Cross-market 2026 snapshot — same framework, different markets, different reads.** None of these are recommendations; they are readings of the framework against publicly available 2026 data, intended to demonstrate that the same framework produces different answers in different market contexts.\n\n- **Sun Belt secondaries** (Phoenix, Austin, Nashville, Tampa, Charlotte, Atlanta): demand drivers mostly yellow (softening from green); supply driver red in most (4-7% deliveries of stock annually through 2023-2025). Vacancy moved from sub-5% to 7-9% in the most-affected secondaries. Concessions of 1-3 months returned on new lease-ups.\n- **Mid-Atlantic + Midwest reshoring beneficiaries** (Columbus, Indianapolis, Kansas City, Cincinnati): demand drivers green-to-yellow; supply mostly green (1.5-2.5% of stock annually). Less capital flow during 2019-2022 meant a thinner 2023-2025 delivery wave. Thin pipeline meets healthy demand stack.\n- **Coastal gateway metros** (NYC, SF, LA, Boston): rate-sensitive cap-rate dynamics dominate the fundamentals. Demand mixed, supply constrained. Different game; framework still applies, but weight of each driver shifts.\n- **Mountain West** (Salt Lake City, Denver, Boise, Reno): variable by metro. Some following the Sun Belt softening pattern with a lag; some holding green across all four. Read metro by metro, not as a region.\n\nThe framework holds across cycles. The data inside it moves. An operator who learned to do this reading themselves — going back to BLS, ACS, and Apartment List with fresh data once a quarter — keeps producing current answers in any year, in any market.\n\n**One-page reference** — download the printable cheat sheet at `/takeaways/m4-market-cheat-sheet.pdf`. Driver-by-driver source URLs, green/yellow/red bands, and the 2026 cross-market snapshot in a single visual.",
            example:
              "Revisiting one composite Sun Belt secondary submarket two ways. **In 2018**, the four drivers read: wage growth +2.5% real (5-yr avg, green); job growth +2.8% annual (green); household formation +2.1% annual (green); 24-month supply pipeline 1.4% of stock (green). All four green — the market was operator-attractive across every driver. **By 2026**, the same submarket reads: wage growth +1.2% (yellow); job growth +0.8% (yellow); household formation +0.6% (yellow); 24-month supply pipeline 5.2% of stock (red). The demand drivers softened from green to yellow as the metro absorbed the rapid-growth phase. Capital that piled in 2019-2022 produced a heavy 2023-2025 delivery wave, pushing supply from 1.4% green to 5.2% red. Same operator, same property, fundamentally different *underwriting* decision — because the framework reads different data.",
            pitfalls: [
              'Treating headline job-growth as a sufficient signal without pulling the sector composition. 20,000 logistics warehouse jobs supports B-class workforce housing; 20,000 tech HQ jobs supports A-class urban. Same headline, different rent class.',
              'Confusing population growth with household formation. A submarket can grow 2% in population with household formation at 0.8% (people staying in multi-generational households because rent has outpaced wages). That market has rent-ceiling problems, not rent-growth opportunities.',
              'Looking only at deliveries this year and missing the 24-month forward pipeline. Capital flowed in 18-24 months ago is landing as deliveries today. Read the pipeline forward, not the deliveries trailing.',
              'Assuming the framework reads the same way across cycles. Sun Belt secondaries scoring all-green in 2018 are a different read in 2026 — not because the framework changed, but because the data inside the framework moved.',
            ],
            related: ['submarket-t01-three-reads', 'submarket-t02-population', 'submarket-t04-supply'],
          },
          // ── Topic 1 ──────────────────────────────────────────────────
          {
